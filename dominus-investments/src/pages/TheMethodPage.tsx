    ...
    <>
      ...
      <footer className="ft-root">
        <div className="ft-inner">
          <div>
            <div className="ft-brand-name">Dominus<span> Investments</span></div>
          ...
          <div>
            ...
            <ul className="ft-links">
              ...
              <li style={{ marginTop: 18, fontStyle: "italic", fontSize: 12, color: "rgba(249,246,241,0.2)", fontFamily: "'Cormorant Garamond', serif" }}>
